...
class StrategyEnhancementConfig:
    ...
    auto_rolling_enabled: bool = True           # Auto-discover newly listed contracts periodically
    discovery_interval_sec: float = 60.0        # Polling frequency for rolling contracts
